...
function UserSearch() {
  ...
  const handleSubmit = (e) => {
      ...
      if (text === '') {
          ...
          //search for users, pass in the text and set as params in the context
          searchUsers(text)
          setText('')
      }
  }
    ...
    return (
    <div className='grid grid-cols-1 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 gaap-8 mb-8'>
        <div>
